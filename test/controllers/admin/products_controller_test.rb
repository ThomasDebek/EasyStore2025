...
class Admin::ProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_product" do
    assert_difference("Admin::Product.count") do
      post admin_products_url, params: { admin_product: { brand_id: @admin_product.brand_id, category_id: @admin_product.category_id, description: @admin_product.description, name: @admin_product.name, price: @admin_product.price } }
    end
  ...
  test "should update admin_product" do
    patch admin_product_url(@admin_product), params: { admin_product: { brand_id: @admin_product.brand_id, category_id: @admin_product.category_id, description: @admin_product.description, name: @admin_product.name, price: @admin_product.price } }
